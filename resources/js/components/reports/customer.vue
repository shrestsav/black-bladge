<template>
    <div class="card" v-if="customer_id!=null && reportType=='customer'">
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col-3">
                    <h6 class="text-black text-uppercase ls-1 mb-1">Customer</h6>
                    <h5 class="h3 text-black mb-0">{{customer.full_name}}</h5>
                </div>
                <div class="col-7">
                    <div class="row">
                        <div class="col-3">
                ...
                <!-- <div class="col-2 text-right">
                    <a
                        :href="origin_url+'/reports/export?report=customerOrders&customer_id='+reports.customer_id+'&type='+reports.type+'&year='+reports.year+'&year_month='+reports.year_month"
                        target="_blank"
                    >
        ...
        <div class="card-footer py-4">
            <div class="row">
                <div class="col-8">
                    <!-- <pagination :data="orders" @pagination-change-page="customerOrders"></pagination> -->
                </div>
                <div class="col-2">
...
export default {
    ...
    methods: {
        ...
        hideModal() {
            this.$refs["customerOders"].hide();
            this.reports.customer_id = "";
        },
        dateTimeWithTz(date) {
            if (date) {
        ...
        customerOrders(page = 1) {
            axios
                ...
                .then(response => {
                    ...
                    this.customer = response.data.meta.customer;
                });
        }
    },
    computed: {
