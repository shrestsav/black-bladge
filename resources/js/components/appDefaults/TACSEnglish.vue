    ...
    <div class="card">
        ...
        <div class="card-body" v-if="module.display">
            <div class="accordion" id="termsAndConditions">
                <div class="card" v-for="(TAC,index) in TACS" :key="index">
...
export default {
    ...
    computed: {
        ...
        TACS() {
            return this.$parent.appDefaults.TACS.en;
        },
        TACSArabic() {
            return this.$parent.appDefaults.TACS.ar;
        }
    }
};
</script>