<template>
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col">
                    <h3 class="mb-0">Software License</h3>
                </div>
                <div class="col-auto">
                    <button
                        type="button"
        ...
        <div class="card-body" v-if="module.display">
            <div class="accordion" id="software_licence_english">
                <div class="card" v-for="(software_licence,index) in software_licences" :key="index">
                    <div class="col-md-12" v-if="editsoftware_licences.status && editsoftware_licences.index==index">
                        ...
                        <div class="form-group">
                            <textarea
                                ...
                                v-model="software_licence.content"
                            ></textarea>
                        </div>
                    ...
                    <template v-else>
                        ...
                        <div
                            ...
                            data-parent="#software_licence_english"
                        >
                            <div class="card-body">
                                ...
                                <div class="text-right">
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn-danger btn-sm"
                                        @click="deletesoftware_licence(index)"
                                    >Delete</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <textarea
                            ...
                            rows="8"
                            placeholder="CONTENT GOES HERE"
                            v-model="newsoftware_licences.content"
                        ></textarea>
                    </div>
                </div>
            </div>
            <div class="text-right">
                <button
                    type="button"
                    class="btn btn-primary btn-sm"
                    @click="addsoftware_licence"
                    v-if="!addsoftware_licences"
                >Add More</button>
                <button
                    type="button"
                    class="btn btn-info btn-sm"
                    @click="savesoftware_licence"
                    v-if="addsoftware_licences"
                >Save</button>
                <button
                    type="button"
...
export default {
    ...
    methods: {
        ...
        savesoftware_licence() {
            ...
            (this.addsoftware_licences = false), this.save();
        },
        save() {
            var data = {
                saveType: "software_licences",
                software_licences: {
                    en: this.software_licences,
                    ar: this.software_licencesArabic
                }
            };
            axios
