<template>
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col">
                    <h3 class="mb-0">Privacy Policies</h3>
                </div>
                <div class="col-auto">
                    <button
                        type="button"
        ...
        <div class="card-body" v-if="module.display">
            <div class="accordion" id="privacy_policies">
                    ...
                    <div class="col-md-12" v-if="editprivacy_policies.status && editprivacy_policies.index==index">
                        ...
                        <div class="form-group">
                            <textarea
                                ...
                                v-model="privacy_policy.content"
                            ></textarea>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-right">
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn-danger btn-sm"
                                        @click="deleteprivacy_policy(index)"
                                    >Delete</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <textarea
                            ...
                            rows="8"
                            placeholder="CONTENT GOES HERE"
                            v-model="newprivacy_policies.content"
                        ></textarea>
                    </div>
                </div>
            </div>
            <div class="text-right">
                <button
                    type="button"
                    class="btn btn-primary btn-sm"
                    @click="addprivacy_policy"
                    v-if="!addprivacy_policies"
                >Add More</button>
                <button
                    type="button"
                    class="btn btn-info btn-sm"
                    @click="saveprivacy_policy"
                    v-if="addprivacy_policies"
                >Save</button>
                <button
                    type="button"
...
export default {
    ...
    methods: {
        ...
        saveprivacy_policy() {
            ...
            (this.addprivacy_policies = false), this.save();
        },
        save() {
            var data = {
                saveType: "privacy_policies",
                privacy_policies: {
                    en: this.privacy_policies,
                    ar: this.privacy_policiesArabic
                }
            };
            axios
