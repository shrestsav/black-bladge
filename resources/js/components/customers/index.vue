      ...
      <div class="card">
            ...
            >
              <li class="nav-item">
                <a
                  ...
                  :class="active.type=='verified' ? 'active' : ''"
                  data-toggle="tab"
                  href
                  role="tab"
                  aria-controls="tabs-icons-text-1"
                  aria-selected="false"
                  @click="switchCustomer('verified')"
                >Verified Customers</a>
              </li>
              <li class="nav-item">
                <a
                  class="nav-link mb-sm-3 mb-md-0"
                  :class="active.type=='unverified' ? 'active' : ''"
                  data-toggle="tab"
                  href
                  role="tab"
                  aria-controls="tabs-icons-text-1"
                  aria-selected="false"
                  @click="switchCustomer('unverified')"
                >Unverified Customers</a>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input
                    ...
                    :class="{'not-validated':errors.fname}"
                    type="text"
                    class="form-control"
                  />
                </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input
                    ...
                    :class="{'not-validated':errors.lname}"
                    type="text"
                    class="form-control"
                  />
                </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input
                    ...
                    :class="{'not-validated':errors.phone}"
                    type="text"
                    class="form-control"
                  />
                </div>
        ...
        <div class="table-responsive">
          <table class="table align-items-center table-flush">
                ...
                <th>
                  <div class v-if="active.type=='unverified'">
                    <a
                      ...
                      @click="deleteUnverifiedCustomers"
                      v-if="active.selectedIds.length && active.select"
                    >Delete</a>
                    <a
                      href="javascript:;"
                      class="btn btn-sm btn-neutral"
                      @click="active.select = !active.select"
                      v-if="!active.select"
                    >Select</a>
                    <a
                      href="javascript:;"
            ...
            <tbody class="list">
              <tr v-for="(item,key) in customers.data" :key="key">
                <td>
                  ...
                  <div class="custom-control custom-checkbox" v-if="active.select">
                    <input
                      ...
                      :id="'check_'+key"
                      type="checkbox"
                      @change="selectCustomer(item.id,$event)"
                    />
        ...
        <div class="card-footer py-4" v-if="customers.data">
          <pagination
            v-if="active.type=='verified'"
            :data="customers"
            @pagination-change-page="getVerifiedCustomers"
          ></pagination>
          <pagination
            v-if="active.type=='unverified'"
            :data="customers"
            @pagination-change-page="getUnverifiedCustomers"
          ></pagination>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    switchCustomer(type) {
      ...
      if (type == "verified") this.getVerifiedCustomers();
      else if (type == "unverified") this.getUnverifiedCustomers();
    },
    ...
    getUnverifiedCustomers(page = 1) {
      axios.get("/unverifiedCustomers?page=" + page).then(response => {
        this.customers = response.data;
      });
    },
    ...
    edit(key) {
      ...
      this.activeCustomer = this.customers.data[key];
    },
    discardEdit() {
    ...
    updateEditedData() {
      axios
        ...
        .then(response => {
          this.activeCustomer.fname = this.customer.fname;
          this.activeCustomer.lname = this.customer.lname;
          this.activeCustomer.email = this.customer.email;
          this.activeCustomer.phone = this.customer.phone;
          this.discardEdit();
